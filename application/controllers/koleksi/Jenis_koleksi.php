...
class Jenis_koleksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Admin | Jenis Koleksi'
        ];
        $data['users'] = $this->db->get_where('tbl_users', ['email' =>
        $this->session->userdata('email')])->row_array();
        $data['jenis'] = $this->Jenis_koleksi_model->getAllJoin();
        $data['koleksi'] = $this->Koleksi_model->getAll();
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar');
        $this->load->view('templates/topbar');
        $this->load->view('admin/koleksi/jenis_koleksi/index', $data);
        $this->load->view('templates/footer');
    }

    public function insert()
    {
        $this->form_validation->set_rules('nama_jenis_koleksi', 'Nama Jenis Koleksi', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('koleksi/jenis_koleksi');
        } else {

            $nama_jenis_koleksi = $this->input->post('nama_jenis_koleksi');
            ...
            $data = [
                ...
                'id_users' => $id_users,
                'time_create_jenis_koleksi' => date('Y-m-d H:i:s')
            ];

            $insert = $this->Jenis_koleksi_model->insert($data);
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $nama_jenis_koleksi = $this->input->post('nama_jenis_koleksi');
            $id_users = $this->input->post('id_users');
            $id = $this->input->post('id_jenis_koleksi');

            date_default_timezone_set("ASIA/JAKARTA");
            $data = [
                'nama_jenis_koleksi' => $nama_jenis_koleksi,
                'id_users' => $id_users,
                'time_update_jenis_koleksi' => date('Y-m-d H:i:s')
            ];

            $update = $this->Jenis_koleksi_model->update($id, $data);
    ...
    {
        $data['id_jenis_koleksi'] = $this->Jenis_koleksi_model->delete($id);
