...
class Jenis_koleksi_model extends CI_Model
{
    ...
    public function getAllJoin()
    {
        $this->db->select('*');
        $this->db->from('tbl_jenis_koleksi');
        $this->db->join('tbl_users', 'tbl_users.id_users = tbl_jenis_koleksi.id_users');
    ...
    {
        $this->db->insert('tbl_jenis_koleksi', $data);
    ...
    public function update($id, $data)
    {
        ...
        $this->db->update('tbl_jenis_koleksi', $data);
    ...
    {
        $this->db->where('id_jenis_koleksi', $id);
        $this->db->delete('tbl_jenis_koleksi');
